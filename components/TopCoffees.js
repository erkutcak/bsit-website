import { coffees } from '@/constants/tops'
    ...
    const displaySpots = coffees.map((restaurant) => (
        <li className='my-4 flex flex-col justify-between h-40 rounded shadow-xl' style={{ backgroundImage: `url(${restaurant.background})`, backgroundSize: 'cover' }} key={restaurant.id}>
            ...
            <div className='flex items-center mt-2 flex-wrap justify-around'>
                ...
                <button className='font-bitter px-3 py-2 text-xs font-medium text-center text-white bg-[#A67DB8] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 shadow-xl'>
                ...
                {restaurant.delivery ? 
                    ...
                    : 
                    <p className=' w-[77px] font-bitter px-3 py-2 text-xs font-medium text-center text-white bg-[#A67DB8] rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-500 dark:hover:bg-gray-700 dark:focus:ring-blue-800 shadow-xl'>Walk-in</p>
                }
            </div>
        </li>
    ))
...
// className='font-bitter w-[77px] px-1 py-1 text-xs font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'
// className='font-bitter w-[77px] px-1 py-1 text-xs font-medium text-center text-white bg-green-700 rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'