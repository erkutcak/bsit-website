    ...
    const displaySpots = pizzas.map((restaurant) => (
        <li className='my-4 flex-column' key={restaurant.id}>
            ...
            <div className='flex items-center mt-2 flex-wrap justify-around'>
                <div className="flex items-center px-3 py-2 text-xs font-medium text-center text-white bg-[#A67DB8] rounded-lg hover:bg-[#A67DB8] focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">
                ...
                {
                !restaurant.delivery && (
                    <p className=' w-[77px] font-bitter px-3 py-2 text-xs font-medium text-center text-red bg-[#A67DB8] rounded-lg hover:bg-[#A67DB8] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-500 dark:hover:bg-gray-700 dark:focus:ring-blue-800'>Walk-in</p>
                )
                }
            </div>
        </li>
