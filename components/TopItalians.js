    ...
    const displaySpots = italians.map((restaurant) => (
        <li className='my-4 flex-column' key={restaurant.id}>
            ...
            <div className='flex items-center mt-2 flex-wrap justify-around'>
                <div className="flex items-center px-3 py-2 my-1 text-xs font-medium text-center text-white bg-[#A67DB8] rounded-lg hover:bg-[#A67DB8] focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800">
