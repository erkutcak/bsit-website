    ...
    const displaySpots = italians.map((restaurant) => (
        <li className='my-4 flex flex-col justify-between h-40 rounded shadow-xl' style={{ backgroundImage: `url(${restaurant.background})`, backgroundSize: 'cover' }} key={restaurant.id}>
            ...
            <div className='flex items-center mt-2 flex-wrap justify-around'>
                ...
                <button className='font-bitter px-3 py-2 text-xs font-medium shadow-xl text-center text-white bg-[#A67DB8] rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'>
                ...
                <button className='font-bitter w-[77px] px-1 py-2 text-xs shadow-xl font-medium text-center text-white bg-[#86C987] rounded-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'>
                    <a href={restaurant.booking}>Book Now!</a> 
                </button>
                    : 
                    <p className=' w-[77px] font-bitter px-3 py-2 text-xs font-medium text-center text-white bg-[#A67DB8] shadow-xl rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-500 dark:hover:bg-gray-700 dark:focus:ring-blue-800'>Walk-in</p>}
            </div>
        </li>
    ))

    return (
        <ul className='bg-white/[.8] mx-8 my-4 px-7 py-[4px] rounded-lg list-decimal shadow-xl'>
