...
const Levain = () => {
  ...
  const displayIngredients = recipes[1].ingredients.map((ingredient, index) => (
    <div key={index}>
  ...
  const displayInstructions = recipes[1].instructions.map((instruction, index) => (
    <div key={index}>
      <ul className='mb-2 mx-4 md:list-none list-disc'>
