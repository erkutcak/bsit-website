...
const Sebastian = () => {
  ...
  const displayIngredients = recipes[2].ingredients.map((ingredient, index) => (
    <div key={index}>
  ...
  const displayInstructions = recipes[2].instructions.map((instruction, index) => (
    <div key={index}>
      <ul className='mb-2 mx-4 md:list-none list-disc'>
